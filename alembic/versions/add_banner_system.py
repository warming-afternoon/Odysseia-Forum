...
def upgrade() -> None:
    ...
    op.create_index('ix_banner_application_thread_id', 'banner_application', ['thread_id'])
    op.create_index('ix_banner_application_channel_id', 'banner_application', ['channel_id'])
    op.create_index('ix_banner_application_applicant_id', 'banner_application', ['applicant_id'])
    op.create_index('ix_banner_application_target_scope', 'banner_application', ['target_scope'])
