...
class TimeRangeModal(discord.ui.Modal, title="设置时间范围"):
    def __init__(
        self,
        submit_callback: Callable[[discord.Interaction, Dict[str, Optional[str]]], Coroutine],
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        created_before_input = cast(discord.ui.TextInput, created_before_label.component)
